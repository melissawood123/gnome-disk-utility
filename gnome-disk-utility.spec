...
Source0  : https://download.gnome.org/sources/gnome-disk-utility/3.38/gnome-disk-utility-3.38.1.tar.xz
...
%prep
%setup -q -n gnome-disk-utility-3.38.1
cd %{_builddir}/gnome-disk-utility-3.38.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609969316
...
cp %{_builddir}/gnome-disk-utility-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-disk-utility/4cc77b90af91e615a64ae04893fdffa7939db84c
