...
Source0  : https://download.gnome.org/sources/gnome-disk-utility/3.30/gnome-disk-utility-3.30.1.tar.xz
...
%prep
%setup -q -n gnome-disk-utility-3.30.1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537864182
