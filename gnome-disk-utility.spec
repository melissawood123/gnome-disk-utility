...
Version  : 3.34.0
Release  : 9
URL      : https://download.gnome.org/sources/gnome-disk-utility/3.34/gnome-disk-utility-3.34.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-disk-utility/3.34/gnome-disk-utility-3.34.0.tar.xz
...
%prep
%setup -q -n gnome-disk-utility-3.34.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568128379
